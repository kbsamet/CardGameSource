...
func show_dialogue_balloon(parent: Node, resource: DialogueResource, title: String = "", extra_game_states: Array = []) -> Node:
	...
	return show_dialogue_balloon_scene(parent,balloon_path, resource, title, extra_game_states)


## Show a given balloon scene
func show_dialogue_balloon_scene(parent:Node,balloon_scene, resource: DialogueResource, title: String = "", extra_game_states: Array = []) -> Node:
